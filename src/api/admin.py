...
from .models import db, User, Employee, TicketEmployeesRelation, Ticket, Customer, Occurrence, Machine, Tag, TagOccurrence, Malfunction, Solution, UserType
...
def setup_admin(app):
    ...
    admin.add_view(Mike(TicketEmployeesRelation, db.session))
