...
class Employee(db.Model):
    ...
    tickets = db.relationship('TicketEmployersRelation', backref='employee', lazy='dynamic')
...
class Ticket(db.Model):
    ...
    machine_serial_number = db.Column(db.String(50), db.ForeignKey('machine.serial_number'), nullable=False)
    ...
    ticket_employee_relation = db.relationship('TicketEmployersRelation', backref='ticket', lazy='dynamic')
