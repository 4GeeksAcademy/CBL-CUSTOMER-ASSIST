...
export const MainBdLayout = ({ children }) => {
    ...
    return (
        <div className={pathname === '/' || pathname === '/loading' || pathname === '/landing' ? "container-xxl gx-0 shadow h-10" : "container-xxl gx-0 shadow h-100 bd-layout"} style={{ position: "relative" }}>
            {children}
